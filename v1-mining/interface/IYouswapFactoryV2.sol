...
interface IYouswapFactoryV2 {
    ...
    zone：矿池分区
     */
    event UpdatePool(bool action, uint256 pool, address indexed lp, string name, uint256 startBlock, uint256 rewardTotal, uint256 rewardPerBlock, uint256 multiple, uint256 priority, uint256 zone);
    ...
    */
    ...
    新建矿池
     */
    function addPool(string memory, address, uint256, uint256, uint256, address, uint256, uint256) external returns (bool);
    ...
    修改矿池分区
     */
    function setZone(uint256, uint256) external;
